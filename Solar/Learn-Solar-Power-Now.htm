---
layout: default
title: Learn Solar Page | MMINAIL
---
...
<p class="lead">
	<span>Welcome! This is the Learn Solar page of the <abbr class='oblique-text' title='Medical Marijuana Initiative of North America - International Limited, an Arizona Benefit Corporation'>MMINAIL</abbr>.</span>
</p>
	<hr class="green-groove" />
...
<p>
    <span>You, as the current end-user, are now at one of those 'Learn-Topic' pages, specifically the {title} ( Learn Solar ) page.</span>
</p>
    <hr class="green-groove" />
...
<p>
	<span>How much of your coding time are you willing to invest in this project?</span>
</p>

<p>
	<span>As we can now decipher the time spent by our functions at the code block level ...</span>
</p>
...
<picture>
	...
	<img class="img-responsive img-circle" src="../images/svg/MMINAIL-Logo-Badge-Original-Registered-Transparent-320-x-320.svg" alt="Medical Marijuana Initiative of North America - International Limited, an Arizona Benefit Corporation USPTO Registered Logo Badge" /></a>
</picture>
	<br />

<hgroup class='text-left'>
	<h4>List of Image Assets</h4>
</hgroup>
	<hr class='green-groove' />
...
<footer class="page-footer center-block">
	...
	<p>
    	...
    	<a href="#" title="Click to Review Place Title Here" target="_blank">Title of Source</a>
	</p>

	<p>
		<span>See: <a href="#" title="Click to Review Place Title Here by Place Author Here" target="_blank">eBook</a>
		<span>by</span>
		<a href="#" title="Click to Review the Place Publisher Here ... author ... Place Author Here" target="_blank">Author</a>
	</p>

	<p>
		<span>Original Copyright 2000 Publisher,</span>
		<br />
		<span>City, NY</span>
	</p>
		<hr class="green-groove" />
